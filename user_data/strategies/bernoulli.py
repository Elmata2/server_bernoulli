...
# --- Used indicators of strategy code ----
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        # MFI7 voor de koop en verkoop
        dataframe['mfi7'] = ta.MFI(dataframe, timeperiod=7)
        
        # MFI14 voor de strategy
        dataframe['mfi14'] = ta.MFI(dataframe, timeperiod=14)
